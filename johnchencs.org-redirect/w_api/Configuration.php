...
class Configuration
{
	const RESELLER_REQUEST_SECRET = 'da328f6f467bde902e5ed3091b790b496e9db7d95191b90fe57486f35913ff9d';
	const ERROR_REPORTING_LEVEL = 0;
	const DEPLOYED_HOSTNAME = 'johnchencs.org';
	const BUILDDATE = 1477909146;
